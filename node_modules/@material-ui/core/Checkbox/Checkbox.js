...
function Checkbox(props) {
  ...
  return _react.default.createElement(_SwitchBase.default, (0, _extends2.default)({
    ...
    className: (0, _clsx2.default)((0, _defineProperty2.default)({}, classes.indeterminate, indeterminate), className),
    classes: {
      root: (0, _clsx2.default)(classes.root, classes["color".concat((0, _helpers.capitalize)(color))]),
