...
function Avatar(props) {
  ...
  if (img) {
    ...
    children = _react.default.cloneElement(childrenProp, {
      className: (0, _clsx2.default)(childrenClassNameProp, childrenProp.props.className)
    });
  } else {
  ...
  return _react.default.createElement(Component, (0, _extends2.default)({
    className: (0, _clsx2.default)(classes.root, classes.system, (0, _defineProperty2.default)({}, classes.colorDefault, !img), classNameProp)
  }, other), children);
}
