...
function InputAdornment(props) {
  ...
  return _react.default.createElement(_FormControlContext.default.Provider, {
    ...
    className: (0, _clsx2.default)(classes.root, (_clsx = {}, (0, _defineProperty2.default)(_clsx, classes.filled, variant === 'filled'), (0, _defineProperty2.default)(_clsx, classes.positionStart, position === 'start'), (0, _defineProperty2.default)(_clsx, classes.positionEnd, position === 'end'), (0, _defineProperty2.default)(_clsx, classes.disablePointerEvents, disablePointerEvents), _clsx), className)
