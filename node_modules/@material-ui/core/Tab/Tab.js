    ...
    value: function render() {
      ...
      if (labelProp !== undefined) {
        label = _react.default.createElement("span", {
          ...
          className: (0, _clsx3.default)(classes.label, (0, _defineProperty2.default)({}, classes.labelWrapped, this.state.labelWrapped)),
      ...
      return _react.default.createElement(_ButtonBase.default, (0, _extends3.default)({
        focusRipple: true,
        className: (0, _clsx3.default)(classes.root, classes["textColor".concat((0, _helpers.capitalize)(textColor))], (_clsx2 = {}, (0, _defineProperty2.default)(_clsx2, classes.disabled, disabled), (0, _defineProperty2.default)(_clsx2, classes.selected, selected), (0, _defineProperty2.default)(_clsx2, classes.labelIcon, icon && label), (0, _defineProperty2.default)(_clsx2, classes.fullWidth, fullWidth), _clsx2), className),
        role: "tab",
