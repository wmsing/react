    ...
    value: function render() {
      ...
      if (labelProp !== undefined) {
        label = React.createElement("span", {
          ...
          className: clsx(classes.label, _defineProperty({}, classes.labelWrapped, this.state.labelWrapped)),
      ...
      return React.createElement(ButtonBase, _extends({
        focusRipple: true,
        className: clsx(classes.root, classes["textColor".concat(capitalize(textColor))], (_clsx2 = {}, _defineProperty(_clsx2, classes.disabled, disabled), _defineProperty(_clsx2, classes.selected, selected), _defineProperty(_clsx2, classes.labelIcon, icon && label), _defineProperty(_clsx2, classes.fullWidth, fullWidth), _clsx2), className),
        role: "tab",
