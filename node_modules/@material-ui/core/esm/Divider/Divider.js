...
function Divider(props) {
  ...
  return React.createElement(Component, _extends({
    className: clsx(classes.root, (_clsx = {}, _defineProperty(_clsx, classes.inset, inset || variant === 'inset'), _defineProperty(_clsx, classes.middle, variant === 'middle'), _defineProperty(_clsx, classes.absolute, absolute), _defineProperty(_clsx, classes.light, light), _clsx), className)
  }, other));
}
