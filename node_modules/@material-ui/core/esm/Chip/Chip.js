  ...
  _createClass(Chip, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          other = _objectWithoutProperties(_this$props2, ["avatar", "classes", "className", "clickable", "color", "component", "deleteIcon", "icon", "label", "onClick", "onDelete", "onKeyDown", "onKeyUp", "variant"]);

      var clickable = clickableProp !== false && onClick ? true : clickableProp;
      var className = clsx(classes.root, (_clsx = {}, _defineProperty(_clsx, classes["color".concat(capitalize(color))], color !== 'default'), _defineProperty(_clsx, classes.clickable, clickable), _defineProperty(_clsx, classes["clickableColor".concat(capitalize(color))], clickable && color !== 'default'), _defineProperty(_clsx, classes.deletable, onDelete), _defineProperty(_clsx, classes["deletableColor".concat(capitalize(color))], onDelete && color !== 'default'), _defineProperty(_clsx, classes.outlined, variant === 'outlined'), _defineProperty(_clsx, classes.outlinedPrimary, variant === 'outlined' && color === 'primary'), _defineProperty(_clsx, classes.outlinedSecondary, variant === 'outlined' && color === 'secondary'), _clsx), classNameProp);
      var deleteIcon = null;
      ...
      if (avatarProp && React.isValidElement(avatarProp)) {
        avatar = React.cloneElement(avatarProp, {
          className: clsx(classes.avatar, avatarProp.props.className, _defineProperty({}, classes["avatarColor".concat(capitalize(color))], color !== 'default')),
      ...
      if (iconProp && React.isValidElement(iconProp)) {
        icon = React.cloneElement(iconProp, {
          className: clsx(classes.icon, iconProp.props.className, _defineProperty({}, classes["iconColor".concat(capitalize(color))], color !== 'default'))
        });
      }
