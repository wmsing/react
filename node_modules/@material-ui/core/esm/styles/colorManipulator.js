...
export function getContrastRatio(foreground, background) {
  process.env.NODE_ENV !== "production" ? warning(foreground, "Material-UI: missing foreground argument in getContrastRatio(".concat(foreground, ", ").concat(background, ").")) : void 0;
  process.env.NODE_ENV !== "production" ? warning(background, "Material-UI: missing background argument in getContrastRatio(".concat(foreground, ", ").concat(background, ").")) : void 0;
...
export function getLuminance(color) {
  process.env.NODE_ENV !== "production" ? warning(color, "Material-UI: missing color argument in getLuminance(".concat(color, ").")) : void 0;
