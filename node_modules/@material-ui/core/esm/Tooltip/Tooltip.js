  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, React.createElement(RootRef, {
        ...
        className: clsx(classes.popper, _defineProperty({}, classes.popperInteractive, interactive)),
        placement: placement,
        ...
        return React.createElement(TransitionComponent, _extends({
          ...
          className: clsx(classes.tooltip, _defineProperty({}, classes.touch, _this2.ignoreNonTouchEvents), classes["tooltipPlacement".concat(capitalize(placementInner.split('-')[0]))])
        }, title));
      }));
    }
  }]);
