  ...
  _createClass(ExpansionPanelSummary, [{
    ...
    value: function render() {
      ...
      return React.createElement(ButtonBase, _extends({
        ...
        className: clsx(classes.root, (_clsx = {}, _defineProperty(_clsx, classes.disabled, disabled), _defineProperty(_clsx, classes.expanded, expanded), _defineProperty(_clsx, classes.focused, focused), _clsx), className),
        onFocusVisible: this.handleFocusVisible,
        onBlur: this.handleBlur,
        onClick: this.handleChange
      }, other), React.createElement("div", {
        className: clsx(classes.content, _defineProperty({}, classes.expanded, expanded))
      }, children), expandIcon && React.createElement(IconButton, _extends({
        disabled: disabled,
        className: clsx(classes.expandIcon, _defineProperty({}, classes.expanded, expanded)),
        component: "div",
        tabIndex: -1,
        "aria-hidden": "true"
