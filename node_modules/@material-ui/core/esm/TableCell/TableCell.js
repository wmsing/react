...
function TableCell(props) {
  ...
  return React.createElement(TableContext.Consumer, null, function (table) {
    return React.createElement(Tablelvl2Context.Consumer, null, function (tablelvl2) {
      ...
      var className = clsx(classes.root, (_clsx = {}, _defineProperty(_clsx, classes.head, variant ? variant === 'head' : tablelvl2 && tablelvl2.variant === 'head'), _defineProperty(_clsx, classes.body, variant ? variant === 'body' : tablelvl2 && tablelvl2.variant === 'body'), _defineProperty(_clsx, classes.footer, variant ? variant === 'footer' : tablelvl2 && tablelvl2.variant === 'footer'), _defineProperty(_clsx, classes["align".concat(capitalize(align))], align !== 'inherit'), _defineProperty(_clsx, classes.numeric, numeric), _defineProperty(_clsx, classes["padding".concat(capitalize(padding))], padding !== 'default'), _clsx), classNameProp);
      var ariaSort = null;
