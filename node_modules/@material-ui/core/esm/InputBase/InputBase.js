  ...
  _createClass(InputBase, [{
    ...
    value: function render() {
      ...
      var inputPropsClassName = _this$props2$inputPro.className,
          ...
          other = _objectWithoutProperties(_this$props2, ["autoComplete", "autoFocus", "classes", "className", "defaultValue", "disabled", "endAdornment", "error", "fullWidth", "id", "inputComponent", "inputProps", "inputRef", "margin", "muiFormControl", "multiline", "name", "onBlur", "onChange", "onClick", "onEmpty", "onFilled", "onFocus", "onKeyDown", "onKeyUp", "placeholder", "readOnly", "renderPrefix", "rows", "rowsMax", "startAdornment", "type", "value"]);
      ...
      var inputClassName = clsx(classes.input, (_clsx2 = {}, _defineProperty(_clsx2, classes.disabled, fcs.disabled), _defineProperty(_clsx2, classes.inputType, type !== 'text'), _defineProperty(_clsx2, classes.inputTypeSearch, type === 'search'), _defineProperty(_clsx2, classes.inputMultiline, multiline), _defineProperty(_clsx2, classes.inputMarginDense, fcs.margin === 'dense'), _defineProperty(_clsx2, classes.inputAdornedStart, startAdornment), _defineProperty(_clsx2, classes.inputAdornedEnd, endAdornment), _clsx2), inputPropsClassName);
