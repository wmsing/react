...
function MobileStepper(props) {
  ...
  var className = clsx(classes.root, classes["position".concat(capitalize(position))], classNameProp);
  return React.createElement(Paper, _extends({
    ...
    var dotClassName = clsx(classes.dot, _defineProperty({}, classes.dotActive, step === activeStep)); // eslint-disable-next-line react/no-array-index-key
