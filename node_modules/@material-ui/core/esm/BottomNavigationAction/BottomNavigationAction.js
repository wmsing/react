  ...
  _createClass(BottomNavigationAction, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          other = _objectWithoutProperties(_this$props2, ["classes", "className", "icon", "label", "onChange", "onClick", "selected", "showLabel", "value"]);

      var className = clsx(classes.root, (_clsx = {}, _defineProperty(_clsx, classes.selected, selected), _defineProperty(_clsx, classes.iconOnly, !showLabelProp && !selected), _clsx), classNameProp);
      var labelClassName = clsx(classes.label, (_clsx2 = {}, _defineProperty(_clsx2, classes.selected, selected), _defineProperty(_clsx2, classes.iconOnly, !showLabelProp && !selected), _clsx2));
