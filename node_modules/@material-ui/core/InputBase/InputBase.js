...
function (_React$Component) {
  ...
  (0, _createClass2.default)(InputBase, [{
    ...
    value: function render() {
      ...
      var className = (0, _clsx3.default)(classes.root, (_clsx = {}, (0, _defineProperty2.default)(_clsx, classes.disabled, fcs.disabled), (0, _defineProperty2.default)(_clsx, classes.error, fcs.error), (0, _defineProperty2.default)(_clsx, classes.fullWidth, fullWidth), (0, _defineProperty2.default)(_clsx, classes.focused, focused), (0, _defineProperty2.default)(_clsx, classes.formControl, muiFormControl), (0, _defineProperty2.default)(_clsx, classes.marginDense, fcs.margin === 'dense'), (0, _defineProperty2.default)(_clsx, classes.multiline, multiline), (0, _defineProperty2.default)(_clsx, classes.adornedStart, startAdornment), (0, _defineProperty2.default)(_clsx, classes.adornedEnd, endAdornment), _clsx), classNameProp);
      var inputClassName = (0, _clsx3.default)(classes.input, (_clsx2 = {}, (0, _defineProperty2.default)(_clsx2, classes.disabled, fcs.disabled), (0, _defineProperty2.default)(_clsx2, classes.inputType, type !== 'text'), (0, _defineProperty2.default)(_clsx2, classes.inputTypeSearch, type === 'search'), (0, _defineProperty2.default)(_clsx2, classes.inputMultiline, multiline), (0, _defineProperty2.default)(_clsx2, classes.inputMarginDense, fcs.margin === 'dense'), (0, _defineProperty2.default)(_clsx2, classes.inputAdornedStart, startAdornment), (0, _defineProperty2.default)(_clsx2, classes.inputAdornedEnd, endAdornment), _clsx2), inputPropsClassName);
