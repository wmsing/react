...
function (_React$Component) {
  ...
  function Modal(props) {
    ...
    _this.isTopModal = function () {
      return _this.props.manager.isTopModal((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    };
  ...
  (0, _createClass2.default)(Modal, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Portal.default, {
        ...
        role: "presentation",
        className: (0, _clsx2.default)(classes.root, className, (0, _defineProperty2.default)({}, classes.hidden, exited))
