...
function LinearProgress(props) {
  ...
  var className = (0, _clsx5.default)(classes.root, (_clsx = {}, (0, _defineProperty2.default)(_clsx, classes.colorPrimary, color === 'primary'), (0, _defineProperty2.default)(_clsx, classes.colorSecondary, color === 'secondary'), (0, _defineProperty2.default)(_clsx, classes.determinate, variant === 'determinate'), (0, _defineProperty2.default)(_clsx, classes.indeterminate, variant === 'indeterminate'), (0, _defineProperty2.default)(_clsx, classes.buffer, variant === 'buffer'), (0, _defineProperty2.default)(_clsx, classes.query, variant === 'query'), _clsx), classNameProp);
  var dashedClass = (0, _clsx5.default)(classes.dashed, (_clsx2 = {}, (0, _defineProperty2.default)(_clsx2, classes.dashedColorPrimary, color === 'primary'), (0, _defineProperty2.default)(_clsx2, classes.dashedColorSecondary, color === 'secondary'), _clsx2));
  var bar1ClassName = (0, _clsx5.default)(classes.bar, (_clsx3 = {}, (0, _defineProperty2.default)(_clsx3, classes.barColorPrimary, color === 'primary'), (0, _defineProperty2.default)(_clsx3, classes.barColorSecondary, color === 'secondary'), (0, _defineProperty2.default)(_clsx3, classes.bar1Indeterminate, variant === 'indeterminate' || variant === 'query'), (0, _defineProperty2.default)(_clsx3, classes.bar1Determinate, variant === 'determinate'), (0, _defineProperty2.default)(_clsx3, classes.bar1Buffer, variant === 'buffer'), _clsx3));
  var bar2ClassName = (0, _clsx5.default)(classes.bar, (_clsx4 = {}, (0, _defineProperty2.default)(_clsx4, classes.barColorPrimary, color === 'primary' && variant !== 'buffer'), (0, _defineProperty2.default)(_clsx4, classes.colorPrimary, color === 'primary' && variant === 'buffer'), (0, _defineProperty2.default)(_clsx4, classes.barColorSecondary, color === 'secondary' && variant !== 'buffer'), (0, _defineProperty2.default)(_clsx4, classes.colorSecondary, color === 'secondary' && variant === 'buffer'), (0, _defineProperty2.default)(_clsx4, classes.bar2Indeterminate, variant === 'indeterminate' || variant === 'query'), (0, _defineProperty2.default)(_clsx4, classes.bar2Buffer, variant === 'buffer'), _clsx4));
  var rootProps = {};
  var inlineStyles = {
    bar1: {},
    bar2: {}
