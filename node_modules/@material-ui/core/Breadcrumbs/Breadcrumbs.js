  ...
  (0, _createClass2.default)(Breadcrumbs, [{
    ...
    value: function renderItemsBeforeAndAfter(allItems) {
      ...
      if (itemsBeforeCollapse + itemsAfterCollapse >= allItems.length) {
        process.env.NODE_ENV !== "production" ? (0, _warning.default)(false, ['Material-UI: you have provided an invalid combination of properties to the Breadcrumbs.', // eslint-disable-next-line max-len
