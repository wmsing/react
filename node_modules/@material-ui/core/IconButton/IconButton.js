...
function IconButton(props) {
  ...
  return _react.default.createElement(_ButtonBase.default, (0, _extends2.default)({
    className: (0, _clsx2.default)(classes.root, (_clsx = {}, (0, _defineProperty2.default)(_clsx, classes["color".concat((0, _helpers.capitalize)(color))], color !== 'default'), (0, _defineProperty2.default)(_clsx, classes.disabled, disabled), _clsx), className),
    centerRipple: true,
    focusRipple: true,
    disabled: disabled
