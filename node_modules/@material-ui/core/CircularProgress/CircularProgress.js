...
function CircularProgress(props) {
  ...
  return _react.default.createElement("div", (0, _extends2.default)({
    className: (0, _clsx3.default)(classes.root, (_clsx = {}, (0, _defineProperty2.default)(_clsx, classes["color".concat((0, _helpers.capitalize)(color))], color !== 'inherit'), (0, _defineProperty2.default)(_clsx, classes.indeterminate, variant === 'indeterminate'), (0, _defineProperty2.default)(_clsx, classes.static, variant === 'static'), _clsx), className),
    ...
    className: (0, _clsx3.default)(classes.circle, (_clsx2 = {}, (0, _defineProperty2.default)(_clsx2, classes.circleIndeterminate, variant === 'indeterminate'), (0, _defineProperty2.default)(_clsx2, classes.circleStatic, variant === 'static'), (0, _defineProperty2.default)(_clsx2, classes.circleDisableShrink, disableShrink), _clsx2)),
    style: circleStyle,
    cx: SIZE,
    cy: SIZE,
    r: (SIZE - thickness) / 2,
