...
process.env.NODE_ENV !== "production" ? TablePagination.propTypes = {
  ...
  page: (0, _utils.chainPropTypes)(_propTypes.default.number.isRequired, function (props) {
    ...
    if (page < 0 || page > newLastPage) {
      var message = 'Material-UI: the page prop of a TablePagination is out of range ' + "(0 to ".concat(newLastPage, ", but page is ").concat(page, ")."); // change error message slightly on every check to prevent caching when testing
