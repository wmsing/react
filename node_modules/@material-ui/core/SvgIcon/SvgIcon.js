...
function SvgIcon(props) {
  ...
  return _react.default.createElement(Component, (0, _extends2.default)({
    className: (0, _clsx2.default)(classes.root, (_clsx = {}, (0, _defineProperty2.default)(_clsx, classes["color".concat((0, _helpers.capitalize)(color))], color !== 'inherit'), (0, _defineProperty2.default)(_clsx, classes["fontSize".concat((0, _helpers.capitalize)(fontSize))], fontSize !== 'default'), _clsx), className),
    focusable: "false",
    viewBox: viewBox,
    color: nativeColor,
