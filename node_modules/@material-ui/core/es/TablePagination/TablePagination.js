...
process.env.NODE_ENV !== "production" ? TablePagination.propTypes = {
  ...
  page: chainPropTypes(PropTypes.number.isRequired, props => {
    ...
    if (page < 0 || page > newLastPage) {
      const message = 'Material-UI: the page prop of a TablePagination is out of range ' + `(0 to ${newLastPage}, but page is ${page}).`; // change error message slightly on every check to prevent caching when testing
