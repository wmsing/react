...
function Link(props) {
  const {
    ...
    underline
        ...
        other = _objectWithoutPropertiesLoose(props, ["children", "classes", "className", "component", "TypographyClasses", "underline"]);

  return React.createElement(Typography, _extends({
    className: clsx(classes.root, {
      [classes.button]: component === 'button'
    }, classes[`underline${capitalize(underline)}`], className),
