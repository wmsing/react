...
process.env.NODE_ENV !== "production" ? ListItem.propTypes = {
  ...
  children: chainPropTypes(PropTypes.node, props => {
    ...
    if (secondaryActionIndex !== -1 && secondaryActionIndex !== children.length - 1) {
      return new Error('Material-UI: you used an element after ListItemSecondaryAction. ' + 'For ListItem to detect that it has a secondary action ' + `you must pass it as the last child to ListItem.${process.env.NODE_ENV === 'test' ? Date.now() : ''}`);
    }
