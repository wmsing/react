  ...
  render() {
    const _this$props = this.props,
      ...
      variant
          ...
          other = _objectWithoutPropertiesLoose(_this$props, ["avatar", "classes", "className", "clickable", "color", "component", "deleteIcon", "icon", "label", "onClick", "onDelete", "onKeyDown", "onKeyUp", "variant"]);
