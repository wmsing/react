...
function StepLabel(props) {
  ...
  return _react.default.createElement("span", (0, _extends2.default)({
    className: (0, _clsx4.default)(classes.root, classes[orientation], (_clsx = {}, (0, _defineProperty2.default)(_clsx, classes.disabled, disabled), (0, _defineProperty2.default)(_clsx, classes.alternativeLabel, alternativeLabel), (0, _defineProperty2.default)(_clsx, classes.error, error), _clsx), classNameProp)
  }, other), icon || StepIconComponent ? _react.default.createElement("span", {
    className: (0, _clsx4.default)(classes.iconContainer, (0, _defineProperty2.default)({}, classes.alternativeLabel, alternativeLabel))
    ...
    component: "span",
    className: (0, _clsx4.default)(classes.label, (_clsx3 = {}, (0, _defineProperty2.default)(_clsx3, classes.alternativeLabel, alternativeLabel), (0, _defineProperty2.default)(_clsx3, classes.completed, completed), (0, _defineProperty2.default)(_clsx3, classes.active, active), (0, _defineProperty2.default)(_clsx3, classes.error, error), _clsx3)),
    display: "block"
  }, children), optional));
}
