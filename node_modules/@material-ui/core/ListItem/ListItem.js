...
var ListItem = _react.default.forwardRef(function ListItem(props, ref) {
  ...
  return _react.default.createElement(_MergeListContext.default, {
    ...
    var className = (0, _clsx2.default)(classes.root, classes.default, (_clsx = {}, (0, _defineProperty2.default)(_clsx, classes.dense, dense || hasAvatar), (0, _defineProperty2.default)(_clsx, classes.gutters, !disableGutters), (0, _defineProperty2.default)(_clsx, classes.divider, divider), (0, _defineProperty2.default)(_clsx, classes.disabled, disabled), (0, _defineProperty2.default)(_clsx, classes.button, button), (0, _defineProperty2.default)(_clsx, classes.alignItemsFlexStart, alignItems === 'flex-start'), (0, _defineProperty2.default)(_clsx, classes.secondaryAction, hasSecondaryAction), (0, _defineProperty2.default)(_clsx, classes.selected, selected), _clsx), classNameProp);
...
process.env.NODE_ENV !== "production" ? ListItem.propTypes = {
  ...
  children: (0, _utils.chainPropTypes)(_propTypes.default.node, function (props) {
    ...
    if (secondaryActionIndex !== -1 && secondaryActionIndex !== children.length - 1) {
      return new Error('Material-UI: you used an element after ListItemSecondaryAction. ' + 'For ListItem to detect that it has a secondary action ' + "you must pass it as the last child to ListItem.".concat(process.env.NODE_ENV === 'test' ? Date.now() : ''));
    }
